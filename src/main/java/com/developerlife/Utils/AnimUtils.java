...
/* @see <a href="http://code.google.com/android/samples/ApiDemos/src/com/google/android/samples/view/LayoutAnimation2.html">animations</a> */
     ...
     */
    public static void setLayoutAnimation(ViewGroup panel, Context ctx, int anim) {

        LayoutAnimationController controller = AnimationUtils.loadLayoutAnimation(ctx, anim);
