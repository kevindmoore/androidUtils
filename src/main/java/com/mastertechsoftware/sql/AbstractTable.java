...
public class AbstractTable<T> extends Table<T> {
    ...
    /**
     * Get a single entry that matches the given selection & selection args. This will provide more than just 1 item to search on.
     * @param database
     * @param selection
     * @param selectionArgs
     * @param data
    ...
    */
    ...
    /**
     * Get all entries with the given where clause & args
     * @param database
     * @param whereClause
     * @param whereArgs
     * @param cls
