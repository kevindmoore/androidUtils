...
public interface Tag {
	 ...
	 * 
	 * This latest list is taken from Winamp code via their lead developer,
	 * which apparently created all of the non-standard genres in the first
	 * place:
	 * http://forums.winamp.com/showthread.php?s=7a7b29dcd41c419a5e4de07113752166&threadid=260334
	 */
	public static final String[] DEFAULT_GENRES = { "Blues", "Classic Rock",
			...
			"Noise", "Alt. Rock", "Bass", "Soul", "Punk", "Space",
			"Meditative", "Instrumental Pop", "Instrumental Rock", "Ethnic",
			"Gothic", "Darkwave", "Techno-Industrial", "Electronic",
			"Pop-Folk", "Eurodance", "Dream", "Southern Rock", "Comedy",
			"Cult", "Gangsta Rap", "Top 40", "Christian Rap", "Pop/Funk",
	...
	public void setCoverArt(byte[] rawImageData);
