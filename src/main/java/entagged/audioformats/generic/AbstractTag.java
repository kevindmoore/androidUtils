...
public abstract class AbstractTag implements Tag {
	 ...
	 * (overridden)
	 * 
	 * @see entagged.audioformats.Tag#setCoverArt(byte[] b)
	 */
	public void addCoverArt(byte[] rawImageData) {
		add(createCoverArtField(rawImageData));
	}
	...
	/**
	 * Creates a field which represents the &quot;cover art&quot;.<br>
	 * The field will already contain the given content.  It will be the raw image data
	 * ready for file or display
	 * 
	 * @param content
	 *            The content of the created field.
	 * @return tagfield representing the &quot;track&quot;
	 */
	protected abstract TagField createCoverArtField(byte[] content);
	 ...
	 * (overridden)
	 * 
	 * @see entagged.audioformats.Tag#getCoverArt()
	 */
	public byte[] getCoverArt() {
		List l = get(getCoverArtId());
		
		// We know the item in this list is a TagImageField, so we can do things specific to that.
		TagImageField tif = ((l.size() != 0) ? (TagImageField)(l.get(0)) : null);
		if(tif != null)
			return tif.getContent();
		else return null;
	}
	...
	/**
	 * Returns the identifier for a field representing the &quot;Cover Art&quot;<br>
	 * 
	 * @see TagField#getId()
	 * @return identifier for the &quot;Cover Art&quot; field.
	 */
	protected abstract String getCoverArtId();
	 ...
	 * (overridden)
	 * 
	 * @see entagged.audioformats.Tag#setCoverArt(java.lang.String)
	 */
	public void setCoverArt(byte[] b) {
		set(createCoverArtField(b));
	}
